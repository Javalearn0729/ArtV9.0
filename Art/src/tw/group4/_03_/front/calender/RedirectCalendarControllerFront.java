...
@Controller
public class RedirectCalendarControllerFront {
	...
	@RequestMapping(path = "/03/front/calendar/myCalendar.ctrl", method = RequestMethod.GET)
	public String redirectToMyCalendar(HttpSession session, Model m) {
		...
		return IdentityFilter.loginID+"03/front_calendar/my_calendar";
	}

	@RequestMapping(path = "/03/front/calendar/calendarManagement.ctrl", method = RequestMethod.POST)
