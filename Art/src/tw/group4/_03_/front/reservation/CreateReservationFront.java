...
public class CreateReservationFront {
	...
	@RequestMapping(path = "/03/front/reservation/createReservationDate.ctrl", method = RequestMethod.POST)
	public String createReservationDate(
		...
		return IdentityFilter.loginID+"03/front_reservation/create_choose_date";
	}
...
//			#取得當天已預約的時段
		...
		return IdentityFilter.loginID+"03/front_reservation/create_confirm";
	}
...
//			System.out.println("reservationNo = " + reservation.getReservationNo());
		...
		return IdentityFilter.loginID+"03/front_reservation/create_return";
	}
